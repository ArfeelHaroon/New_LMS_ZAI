                    ...
                    <div class="header__navbar__right">
                        <ul class="header__menu">
                            ...
                            <li class="admin-notification-menu position-relative">
                                <a href="#" class="btn btn-dropdown site-language" id="dropdownNotification"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span
                                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ @$totalAdminNotifications }}</span>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownNotification">
                                    ...
                                    @if (count($adminNotifications))
                                        ...
                                        <form action="{{ route('notification.all-read') }}" method="POST">
                                            @csrf
                                            <button type="submit" class="dropdown-item dropdown-footer">Mark all as
                                                read</button>
                                        </form>
                                    @endif
                                </div>
                            ...
                            <li>
                                <a href="#" class="btn btn-dropdown user-profile" id="dropdownUser"
                                    data-bs-toggle="dropdown" aria-expanded="false">
